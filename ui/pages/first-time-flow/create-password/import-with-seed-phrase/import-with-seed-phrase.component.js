...
export default class ImportWithSeedPhrase extends PureComponent {
  ...
  render() {
    ...
    return (
      <form className="import-seed-phrase__form" onSubmit={this.handleImport}>
        ...
        <div className="import-seed-phrase__header">
          {t('importAccountSeedPhrase')}
        </div>
        <div className="import-seed-phrase__content">
          <div className="import-seed-phrase__content__wrapper">
            <div className="import-seed-phrase__textarea-wrapper">
              <label>{t('secretPhrase')}</label>
              {showSeedPhrase ? (
                <textarea
                  className="import-seed-phrase__textarea"
                ...
                <TextField
                  className="import-seed-phrase__textarea import-seed-phrase__seedphrase"
                  type="password"
                  onChange={(e) => this.handleSeedPhraseChange(e.target.value)}
                  value={this.state.seedPhrase}
              ...
              <div
                className="import-seed-phrase__checkbox-container"
                onClick={this.toggleShowSeedPhrase}
              >
                <div
                  className="import-seed-phrase__checkbox"
                  tabIndex="0"
                  role="checkbox"
                ...
                <span
                  id="ftf-chk1-label"
                  className="import-seed-phrase__checkbox-label"
                >
                  {t('showSeedPhrase')}
                </span>
              </div>
            ...
            <TextField
              ...
              label={t('newPassword')}
              type="password"
              className="import-seed-phrase__input"
            ...
            <TextField
              ...
              type="password"
              className="import-seed-phrase__input inputPassword"
            ...
            >
              <div
                className="import-seed-phrase__checkbox import-seed-phrase__terms"
                tabIndex="0"
                role="checkbox"
              ...
              >
                {t('acceptTermsOfUse', [
                  <a
                    ...
                    key="import-seed-phrase__link-text"
                    href="https://metamask.io/terms.html"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <span className="import-seed-phrase__link-text">
                      {t('terms')}
                    </span>
                  </a>,
                ])}
          ...
          <div>
            <Button
              submit
              className="import-seed-phrase__button"
