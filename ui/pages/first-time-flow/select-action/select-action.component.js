      ...
      <div className="select-action">
            ...
            onClick={(e) => {
              ...
              this.context.metricsEvent({
                eventOpts: {
                  ...
                  name: 'Go Back from Onboarding Select',
                },
              });
        ...
        <div className="select-action__wrapper">
          <div className="select-action__body">
            ...
            <div className="select-action__body-content">
              {t('walletSetupDescription')}
            </div>
            <div className="select-action__select-buttons">
            <div className="select-action__rectangles">
                <div className="select-action__rectangles__rectangle" />
                <div className="select-action__rectangles__rectangle" />
                <div className="select-action__rectangles__rectangle" />
              </div>
