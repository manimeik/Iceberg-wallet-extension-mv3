...
export default class AdvancedTab extends PureComponent {
  ...
  static propTypes = {
    ...
    toggleRecaptcha: PropTypes.func,
  };
  ...
  renderToggleRecaptcha() {
    const { t } = this.context;
    const { shouldShowRecaptcha, toggleRecaptcha } = this.props;

    return (
      <div
        className="settings-page__content-row"
        data-testid="advanced-setting-recaptcha"
      >
        <div className="settings-page__content-item">
          <span>{t('showRecaptcha')}</span>
          <div className="settings-page__content-description">
            {t('showRecaptchaDescription')}
          </div>
        </div>
        <div className="settings-page__content-item">
          <div className="settings-page__content-item-col">
            <ToggleButton
              value={shouldShowRecaptcha}
              onToggle={(value) => toggleRecaptcha(!value)}
              offLabel={t('off')}
              onLabel={t('on')}
            />
          </div>
