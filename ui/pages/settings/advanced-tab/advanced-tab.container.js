...
import {
  ...
  setShowRecaptchaStatus,
} from '../../../store/actions';
import { getPreferences ,getShowRecaptcha} from '../../../selectors';
...
export const mapStateToProps = (state) => {
  ...
  return {
    ...
    useTokenDetection,
    shouldShowRecaptcha: getShowRecaptcha(state),
...
export const mapDispatchToProps = (dispatch) => {
  return {
    ...
    toggleRecaptcha: (value) => dispatch(setShowRecaptchaStatus(value)),
