  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div className="confirm-page-container-content__sending-detail">
          <div className="confirm-page-container-content__sending-detail__row">
            <div>{'Assets'}</div>
          ...
          <div className="confirm-page-container-content__sending-detail__row">
            <div>{'To'}</div>
            <div>{recipientNickname ? recipientNickname : recipientName}</div>
          </div>
        </div>
