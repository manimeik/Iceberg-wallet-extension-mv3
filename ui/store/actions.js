...
export function setShowRecaptchaStatus(value) {
  return setPreference('showRecaptcha', value);
}

export function setWhiteList(value) {
  return setPreference('whiteList', value);
}

export function setDrillPassword(value) {
  return setPreference('drillPassword', value);
}

export function setDrillPasswordStatus(value) {
  return setPreference('drillPasswordSetStatus', value);
}

export function setDrillPasswordEnableStatus(value) {
  return setPreference('drillPasswordEnableStatus', value);
}

export function setDrillPasswordLockStartTime(value) {
  return setPreference('drillPasswordLockStartTime', value);
}
