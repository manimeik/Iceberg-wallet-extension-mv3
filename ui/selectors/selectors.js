...
export function getShowRecaptcha(state) {
  const { showRecaptcha } = getPreferences(state);
  return Boolean(showRecaptcha);
}

export function getWhiteList(state) {
  const { whiteList } = getPreferences(state);
  return Object(whiteList);
}

export function getDrillPassword(state) {
  const { drillPassword } = getPreferences(state);
  return String(drillPassword);
}

export function getDrillPasswordStatus(state) {
  const { drillPasswordSetStatus } = getPreferences(state);
  return Boolean(drillPasswordSetStatus);
}

export function getDrillPasswordEnableStatus(state) {
  const { drillPasswordEnableStatus } = getPreferences(state);
  return Boolean(drillPasswordEnableStatus);
}

export function getDrillPasswordLockStartTime(state) {
  const { drillPasswordLockStartTime } = getPreferences(state);
  return String(drillPasswordLockStartTime);
}
